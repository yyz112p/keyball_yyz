...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_NO    , KC_NO    , KC_LWIN  , MO(4)    , MO(1)    , KC_SPC   , KC_DEL,                 KC_BSPC, KC_ENT   , KC_NO    , KC_NO    , KC_NO    , KC_INT1  , KC_NO    
  ),
//Fn1
  [1] = LAYOUT_universal(
    KC_NO   , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,                                   KC_NO   , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,
    ...
    _______ , C(KC_PGUP), KC_F2   , KC_INT5  , KC_INT4  , C(KC_PGDN) , KC_NO  ,              KC_NO  , KC_0     , KC_1     , KC_2     , KC_3     , S(KC_1)  , S(KC_INT1),
    KC_NO   , KC_NO    , _______  , KC_NO    , KC_NO    , _______  , _______  ,        C(S(KC_TAB)) , C(KC_TAB), KC_NO    , KC_NO    , KC_NO    , S(KC_INT3), KC_NO
  ),
//mouse drag mode
  [2] = LAYOUT_universal(
    KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,                                   KC_NO   , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,
...
//mouse scroll mode
  [3] = LAYOUT_universal(
    KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,                                   KC_NO   , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,
    _______  , KC_VOLU  , KC_F7    , KC_F8    , KC_F9    , KC_F10   ,                                C(S(KC_T)) , KC_BTN4  , KC_PGUP  , KC_BTN5  , KC_PSCR  , KC_NO    ,
    _______  , KC_VOLD  , KC_F4    , KC_F5    , KC_F6    , KC_F11   ,                                    KC_F5  , KC_BTN1  , KC_BTN3  , KC_BTN2  , KC_NO    , KC_NO    ,
    _______  , KC_NO    , KC_F1    , KC_F2    , KC_F3    , KC_F12   , KC_NO    ,             KC_NO   , A(KC_F4) , C(KC_W)  , KC_PGDN  , KC_INT5  , KC_NO    , KC_NO    ,
    KC_NO    , KC_NO    , _______  , KC_NO    , KC_NO    , _______  , _______  ,        C(S(KC_TAB)) , C(KC_TAB), KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    
  ),
//Fn2
  [4] = LAYOUT_universal(
    KC_NO    , KC_NO    , KC_NO     , KC_NO     , KC_NO     , KC_NO     ,                                   KC_NO   , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,
    ...
    _______  , KC_F13   , KC_F14    , KC_F15    , KC_F16    , KC_F17    , KC_NO    ,              KC_NO  , KC_0     , KC_1     , KC_2     , KC_3     , KC_PAST   , KC_NO    ,
    KC_NO    , KC_NO    , KC_NO     , KC_NO     , KC_NO     , _______   , _______  ,        C(S(KC_TAB)) , C(KC_TAB), KC_NO    , KC_NO    , KC_NO    , KC_DOT     , KC_NO         
  ),
};
// clang-format on
